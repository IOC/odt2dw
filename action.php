...
class action_plugin_odt2dw extends DokuWiki_Action_Plugin {
    ...
    function _odt2dw() {
        ...
        //************************ Customized styles *********************************
        /*$nodes = $this->racine->getElementsByTagName( "text" );
        for ( $i = 0; $i < $nodes->length; $i++ ) {
            if ($nodes->item ($i)->getAttribute('text:style-name') === 'Strong_20_Emphasis'){
                $nodes->item($i)->setAttribute( 'text:style-name', 'T2');
            }
        }*/
        //****************************************************************************
